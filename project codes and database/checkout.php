...
<html>
<head>
    <title>Ödeme | Sanal Market</title>
<?php
    include 'header.php'?>
                ...
                <h3>Öde<span>me</span></h3>
                 ...
                 <div class="checkout-right">
                        ...
                        <section class="creditly-wrapper wthree, w3_agileits_wrapper" style="margin-top: 35px">
                            <div class="information-wrapper">
                                <a href="login.php?page=checkout">
                                    <button class="submit check_out btn-block">DEVAM ETMEK İÇİN GİRİŞ YAPIN</button>
                                </a>
                            </div>
                        </section>
                    </div>
                    ...
                    <div class="col-md-12 address_form_agile">
                        <section class="creditly-wrapper wthree, w3_agileits_wrapper" style="margin-top: 35px">
                            <div class="information-wrapper">
                                <button class="submit check_out btn-block">SİPARİŞİNİZ ALINDI</button><br>
                                <p style="text-align:center; color:black;">Siparişinizi <a href="my-orders.php">Siparişlerim </a>Sayfasından Takip Edebilirsiniz.</p><br>
                            </div>
                        </section>
                    </div>
                                 ...
                                 <div class="vertical_post check_box_agile">
                                    <div class="checkbox">
                                        <div class="check_box_one cashon_delivery">
                                            <label class="anim">
                                                <span> Şimdilik Sadece Kapıda Ödeme Seçeneği ile Çalışıyoruz.</span> 
                                            </label> 
                                        </div>
                                    </div>
                                </div>
