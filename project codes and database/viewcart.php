            ...
            <div class="w3l_banner_nav_right">
                ...
                <div class="privacy about">
                    ...
                    <div class="checkout-right">
                        ...
                        >ALIŞVERİŞ SEPETİNİZDE ŞUNLAR VAR: <span><?=count($products)?> ÜRÜN</span></h4>
                    ...
                    <div class="checkout-left">
                        <div class="col-md-4 checkout-left-basket">
                            <ul>
                                <li style="font-size: 20px">Teslimat ücreti <i>-</i> <span class="text-primary">Ücretsiz</span></li>
                                <li><hr></li>
                                <li style="font-weight: bolder;font-size: 20px">Toplam Tutar  <span id="total"><?=$total?></span> <span>₺</span></li>
                        ...
                        <div class="col-md-8 address_form_agile">
                            <section class="creditly-wrapper wthree, w3_agileits_wrapper" style="margin-top: 35px">
                                <div class="information-wrapper">
                                    <button class="submit check_out btn-block">SİPARİŞ VER</button>
                                </div>
                            </section>
                        </div>
