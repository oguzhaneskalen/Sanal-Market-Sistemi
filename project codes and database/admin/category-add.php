            ...
            <div class="col-lg-12 mb-4">
                <form action="include/save-category.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="name" name="name" type="text" placeholder="İsim girin..">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                    	<button class="btn btn-primary">Kategoriyi Kaydet</button>
                    </div>
                </form>
            </div>
          </div>
