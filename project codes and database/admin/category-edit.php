            ...
            <div class="col-lg-12 mb-4">
                <form action="include/update-category .php" method="post">
                    ...
                    <div class="form-group">
                        <label for="pid">Kategori ID</label>
                        <input class="form-control" id="cid" name="cid" type="number" placeholder="ID" value="<?=$category['cid']?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="name">Kategori İsmi</label>
                        <input class="form-control" id="name" name="name" type="text" placeholder="Kategori İsmi" value="<?=$category['name']?>">
                    </div>
                    <div class="form-group">
                        <label for="parent_id">Üst Kategori Seç</label>
