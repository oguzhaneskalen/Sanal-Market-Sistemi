    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Merhaba <?=ucwords($_SESSION['ADMIN_NAME'])?></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="Product" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="products.php">Tüm Ürünler</a>
            <a class="collapse-item" href="product-add.php">Ekle</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="Category" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <!--<h6 class="collapse-header"></h6>-->
            <a class="collapse-item" href="category.php">Tüm Kategoriler</a>
            <a class="collapse-item" href="category-add.php">Ekle</a>
          </div>
        </div>
      </li>
